...
public interface PredicateTest<Integer> {
     ...
     */
    default PredicateTest<Integer> and(PredicateTest<? super Integer> other) {
     ...
     * PredicateTest
     */
    default PredicateTest<Integer> negate() {
        return (t) -> !test(t);
    }
     ...
     * @throws NullPointerException if other is null
     */
    default PredicateTest<Integer> or(PredicateTest<? super Integer> other) {
        Objects.requireNonNull(other);
     ...
     * to {@link Objects#equals(Object, Object)}
     */
    static <Integer> PredicateTest<Integer> isEqual(Object targetRef) {
